            ...
            <div className="bg-rose-50/60 p-3.5 rounded-2xl border border-rose-100 space-y-2">
              <label className="block text-xs font-semibold text-slate-700 flex items-center justify-between">
                <span className="flex items-center gap-1.5 text-rose-700">
                  ...
                  Link / Bài Hát Nhạc Nền Kỷ Niệm
                </span>
                <span className="text-[10px] text-slate-500 font-normal">Hỗ trợ ZingMP3, YouTube, MP3</span>
              </label>
              
              <input
                type="text"
                placeholder="Dán link ZingMP3, YouTube hoặc link MP3 vào đây..."
                value={musicUrl}
              ...
              <div className="flex flex-wrap items-center gap-1.5 pt-1">
                <span className="text-[10px] font-medium text-slate-500">Gợi ý sẵn:</span>
                <button
                  type="button"
                  onClick={() => setMusicUrl('https://zingmp3.vn/album/Thuong-Single-Karik/ZWZCWAUB.html')}
                  className={`px-2.5 py-1 rounded-lg text-[11px] font-medium transition-all ${
                    musicUrl.includes('ZWZCWAUB') || musicUrl.includes('Thuong-Single-Karik')
                      ? 'bg-rose-500 text-white shadow-sm'
                      : 'bg-white text-slate-700 hover:bg-rose-100 border border-slate-200'
                  }`}
                >
                  🎵 Thương - Karik (ZingMP3)
                </button>
              </div>
            </div>
          </div>
